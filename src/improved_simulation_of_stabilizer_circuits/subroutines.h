 ...
 * @param x1 One of the 4 input bits.
 * @param z1 One of the 4 input bits.
 * @param x2 One of the 4 input bits.
 * @param z2 One of the 4 input bits.
 * @return The exponent to which i is raised when the Pauli matrices represented
 * by x1z1 and x2z2 are multiplied.
 */
