...
protected:
   ...
   * @param p_total_bits Number of bits necessary to specify the state using the
   * tableau.
   */
...
public:
   ...
   * The overriding subclass must determine the amount of necessary total_bits
   * from the amount of qubits and call the protected method initializeTableau
   * with 2 arguments appropriately.
   * @param p_n Number of qubits in the system.
   */
  ...
  /**
   * Transform the tableau according to the CNOT gate applied to qubits control
   * and target. After application the tableau stabilizes the state |ψ〉→
   * CNOT(control, target)|ψ〉.
  ...
  /**
   * Transform the tableau according to the Hadamard gate applied to the qubit
   * qubit. After application the tableau stabilizes the state |ψ〉→
   * H(qubit)|ψ〉.
  ...
  /**
   * Transform the tableau according to the Phase gate applied to the qubit
   * qubit. After application the tableau stabilizes the state |ψ〉→
   * Phase(qubit)|ψ〉.
  ...
  /**
   * Transform the tableau according to a measurement performed on qubit given
   * by qubit.
  ...
  /**
   * Apply the Pauli X gate to the qubit via decomposition of X using Hadamard
   * and Phase gates.
  ...
  /**
   * Apply the Pauli Y gate to the qubit via decomposition of Y using Hadamard
   * and Phase gates.
  ...
  /**
   * Apply the Pauli Z gate to the qubit via decomposition of Z using Phase
   * gates.
